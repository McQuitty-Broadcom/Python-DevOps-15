...
- Your login: is mfwsuser15@demo.broadcom.com
...
- Your userid is CUST015.
- Your password CUST015.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS15 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS15 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST015.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST015.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST015
Password: Mfuser15@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-15.git`
